...
Event OnGameEnd(string eventName, string strArg, float numArg, form sender)
    Debug.Trace("[GRMP] OnGameEnd, numArg: " + numArg)
...
Event OnUpdate()
	Debug.Trace("[GRMP] GR_GameAel.OnUpdate()")
	If InGame
		Debug.Trace("[GRMP] GR_GameAel.SendTick()")
		SendModEvent("GR_GameTick", "", 0.0)
		RegisterForSingleUpdate(1.0)
	ElseIf StartingGame
		Debug.Trace("[GRMP] GR_GameAel.StartingGame()")
		StartingGame = False
		InGame = True
