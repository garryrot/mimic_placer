Scriptname BakaTrapTriggerBox extends ObjectReference  
...
State QTEEnter
	...
	Event OnUpdate() ; Loop to check the situation every 1 second.
		...
		if TrapType <= 4
			...
			if TrapType == 2
				(VoreTrapref as StandaloneBakaTrapMimic).MimicShake()
			endif
		endif
...
State QTESuccess
	Event OnBeginState()
		...
		elseif TrapType == 2
			(VoreTrapref as StandaloneBakaTrapMimic).FailVore()
		elseif TrapType == 3
...
State QTEFail
	Event OnBeginState()
		...
		elseif TrapType == 2
			(VoreTrapref as StandaloneBakaTrapMimic).SuccessVore()
		elseif TrapType == 3
